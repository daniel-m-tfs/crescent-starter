...
-- Renderiza template de um arquivo com dados
local render_file
render_file = function(file_path, data)
  local file = io.open(file_path, "r")
  if not file then
    return nil, "Template file not found: " .. tostring(file_path)
  end
  
  local template_string = file:read("*all")
  file:close()
  
  return render(template_string, data or {})
end
